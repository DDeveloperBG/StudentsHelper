...
namespace StudentsHelper.Data.Migrations
{
    ...
    [Migration("20220329161935_AddedStudentFavouriteTeacherEntity")]
    partial class AddedStudentFavouriteTeacherEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("IsPictureValidated")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.ChatGroup", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.ChatGroupUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Favourite.StudentFavouriteTeacher", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("StillIsFavourite")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("StudentsFavouriteTeachers");
                });
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Meeting", b =>
                {
                    ...
                    b.Property<DateTime?>("StudentLastActivity")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("TeacherLastActivity")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.StudentTransaction", b =>
                {
                    ...
                    b.ToTable("StudentsTransactions");
                });
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Teacher", b =>
                {
                    ...
                    b.Property<string>("ExpressConnectedAccountId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.ChatGroupUsers", b =>
                {
                    ...
                    b.HasOne("StudentsHelper.Data.Models.ChatGroup", "ChatGroup")
                        .WithMany("Users")
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Favourite.StudentFavouriteTeacher", b =>
                {
                    b.HasOne("StudentsHelper.Data.Models.Student", "Student")
                        .WithMany("StudentFavouriteTeachers")
                        .HasForeignKey("StudentId");
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Message", b =>
                {
                    b.HasOne("StudentsHelper.Data.Models.ChatGroup", null)
                        .WithMany("Messages")
                        .HasForeignKey("ChatGroupId");

                    b.HasOne("StudentsHelper.Data.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("StudentsHelper.Data.Models.Student", b =>
                {
                    ...
                    b.Navigation("StudentFavouriteTeachers");
